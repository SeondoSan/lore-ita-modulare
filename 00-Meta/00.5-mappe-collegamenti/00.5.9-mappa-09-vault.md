...
- `09.1-società-rifugi.md` (Società di Rifugi)
...
- `09.1-società-rifugi.md` → riferimento alle categorie di vault
...
- `09.1-società-rifugi.md` → riferimento agli esperimenti pianificati
...
- `09.1-società-rifugi.md` → tecnologie di controllo mentale
...
- "Archivisti Grigi" (archivisti dei dati sui vault)
  - **Menzionato in**: `09.1-società-rifugi.md`, `09.5-sopravvissuti-vault.md`, `../05-Fazioni/05.6-custodi-tempo.md`
  - **File principale**: `09.5-sopravvissuti-vault.md` (descrizione principale)
  - **Stato collegamenti**: Da implementare
...
- "Archivio dei Segreti" (2288-2290)
  - **Menzionato in**: `09.0-vault-panoramica.md`, `09.1-società-rifugi.md`, `09.5-sopravvissuti-vault.md`, `../10-Eventi/10.3-sviluppi-tecnologici.md`
  - **File principale**: `../10-Eventi/10.3-sviluppi-tecnologici.md` (presumibilmente)
  - **Stato collegamenti**: Da implementare
...
2. In tutti i file: Collegamenti alle società Fortezza Futura e RIR che dovrebbero puntare a `09.1-società-rifugi.md`
...
1. "Comitato Congiunto" - potrebbe meritare una sezione dedicata in `09.1-società-rifugi.md` data la sua importanza
