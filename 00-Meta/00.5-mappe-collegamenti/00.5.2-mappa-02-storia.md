...
- `../09-Vault/09.1-società-rifugi.md` → riferimento alle corporazioni militari (da implementare)
...
- "Fortezza Futura S.p.A."
  ...
  - **Stato collegamenti**: ✅ Completo
  - **Collegamento esterno**: `../09-Vault/09.1-società-rifugi.md#fortezza-futura-spa`

- "Rifugi Italiani Riuniti (RIR)"
  - **Menzionato in**: `02.3-italia-militare.md`, `02.4-tensioni-finali.md`
  - **File principale**: `02.3-italia-militare.md#rifugi-italiani-riuniti`
  - **Stato collegamenti**: ✅ Completo
  - **Collegamento esterno**: `../09-Vault/09.1-società-rifugi.md#rifugi-italiani-riuniti-rir`
...
2. Da `../09-Vault/09.1-società-rifugi.md` a `02.3-italia-militare.md#corporazioni-militari`
