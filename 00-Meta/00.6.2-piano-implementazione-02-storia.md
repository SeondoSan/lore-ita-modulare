...
- `../09-Vault/09.1-societa-rifugi.md`: Aggiungere collegamenti a Fortezza Futura e RIR in Storia
  ```markdown
  Per il contesto storico della formazione delle societa di rifugi, vedere [L'Italia Militare (2050-2077)](../02-Storia/02.3-italia-militare.md#corporazioni-militari).
  ```
