...
- **MnemoPulse Standard**: Versione base installata in tutti i vault Fortezza Futura
- **MnemoPulse Plus**: Versione avanzata per vault selezionati, con maggiore capacità di personalizzazione
- **MnemoPulse Alpha**: Prototipo sperimentale riservato al Vault 250 e alle strutture di ricerca
- **BioMnemo**: Variante che combinava agenti biologici con stimoli elettromagnetici, utilizzata nel Vault 186
...
- **MemorItalia Base**: Installato in tutti i vault RIR standard
- **MemorItalia Regionale**: Versioni specializzate per adattarsi alle tradizioni culturali locali (variante siciliana, campana, ecc.)
- **MemorItalia Intensivo**: Utilizzato nei vault con problemi di controllo o resistenza
- **MemorItalia Comunitario**: Focalizzato sul condizionamento di gruppo anziché individuale
...
Il culmine di queste tecnologie fu il Progetto "Ri-Genesis", concepito come un'operazione su scala nazionale per riprogrammare completamente la società italiana post-apocalittica.

### Origine e Pianificazione

- **Concepimento**: Ideato congiuntamente da scienziati vaticani, specialisti Fortezza Futura e psicologi RIR nei primi anni '70
- **Coordinamento centrale**: Vault V-01 (Vaticano), con direzione ecclesiastica e scientifica
...
- **Tecnologia primaria**: Versione avanzata integrata dei sistemi MnemoPulse e MemorItalia
...
- **Agenti principali**: Le "Ombre del Verbo" - personale selezionato e intensamente condizionato
...
- Gli agenti "seminatori" delle "Ombre del Verbo" riuscirono a diffondere elementi significativi della narrativa revisionista
...
- **Medievalizzazione effettiva**: Ritorno a strutture sociali pre-industriali come previsto dal Progetto "Ri-Genesis"
...
- **Immunità neurologica**: Una piccola percentuale della popolazione (circa 3-5%) risultava naturalmente immune agli effetti dei sistemi MnemoPulse e MemorItalia
...
- **I Custodi del Tempo**: Gruppo formato da individui naturalmente immuni al condizionamento, dedicati a preservare la vera storia
...
- **"Cerimonie di Risveglio"**: Rituali terapeutici sviluppati dai Custodi del Tempo
...
- **Trattamento ufficiale**: "Purificazione" nello Stato Pontificio (in realtà rafforza il condizionamento)
- **Trattamento alternativo**: "Cerimonie di Risveglio" dei Custodi del Tempo
...
- **"Terminal Risveglio" (2282)**: Dispositivo sviluppato dai tecnici della Repubblica di Venezia che può identificare pattern di condizionamento MnemoPulse attivi
- **"Decodificatore Aurale" (2285)**: Strumento creato da ex-tecnici RIR che può isolare e neutralizzare frequenze subliminali MemorItalia
...
- **"Guaritori della Memoria" (2289-presente)**: Praticanti formati nelle tecniche di "Guarigione dei Ricordi" sviluppate da Margherita Visentin
...
- **"Protocollo Purificazione" (2286-2288)**: Intensificazione delle tecniche di ricondizionamento nelle aree sotto controllo dello Stato Pontificio
...
- **Promotori del Condizionamento**:
  - Stato Pontificio Rinato (eredità diretta del Progetto "Ri-Genesis")
  - Le Ombre del Verbo (agenti specificatamente addestrati a mantenere la narrazione alterata)
  - Elementi conservatori nelle Città-Stato (beneficiari dell'attuale ordine sociale)

- **Resistenza al Condizionamento**:
  - I Custodi del Tempo (combattenti attivi per la preservazione della vera storia)
  - Repubblica di Venezia (approccio pragmatico, interessata principalmente alla verità tecnologica)
  - "Figli della Verità" (movimento clandestino emerso dalla collaborazione tra Custodi del Tempo e ex-Ombre del Verbo pentite)
...
- **Zone di Libertà Mnestica**: Principalmente nelle aree sotto l'influenza della Lega dei Navigli e della Repubblica di Venezia
- **Zone di Controllo Rigido**: Territori dello Stato Pontificio, dove la narrazione ufficiale è imposta con la forza
...
- **Caccia alle Streghe Moderne**: Persecuzione e talvolta esecuzione pubblica di "eretici mnestici" nello Stato Pontificio
...
- Estensione del controllo delle Ombre del Verbo in territori attualmente liberi
...
[← Torna all'indice principale](../01.0-indice-principale.md) | [← Esperimenti Sociali](09.3-esperimenti-sociali.md) | [Sopravvissuti Notevoli →](09.5-sopravvissuti-vault.md)