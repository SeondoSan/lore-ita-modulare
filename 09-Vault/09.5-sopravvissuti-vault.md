...
- **Origine**: Vault 117 (Roma - Fortezza Futura)
...
- **Emerso**: 2200
- **Contributo**: Autoproclamatosi primo "Papa del Nuovo Mondo" e fondatore dello Stato Pontificio Rinato
- **Caratteristiche distintive**:
  - Perfetto prodotto dell'esperimento del Vault 117, completamente convinto della legittimità del modello teocratico medievale
  - Capacità oratoria eccezionale, potenziata dal condizionamento MemorItalia
...
- **Eredità**: 
  - Creò la struttura fondamentale dello Stato Pontificio attuale
  - Stabilì il sistema delle "Indulgenze" come base economica
  - Istituì l'ordine delle Ombre del Verbo come guardiani della "verità storica"
  - Morto nel 2245, venerato come santo con numerosi miracoli attribuitigli

### Il "Doge Tecnico" (Antonio Loredan)

- **Origine**: Vault 186 (Chioggia - Fortezza Futura)
...
- **Contributo**: Principale architetto delle prime piattaforme galleggianti della nuova Venezia
- **Caratteristiche distintive**:
  ...
  - Uno dei pochi umani ad aver mantenuto contatti collaborativi con i Gondolieri
  - Inventore del sistema di ancoraggi flessibili che permette alle piattaforme veneziane di resistere alle maree
- **Eredità**:
  - I principi architettonici da lui stabiliti sono ancora utilizzati nella Repubblica Serenissima
  - Fondò il "Consiglio delle Acque", struttura di governo ancora in uso
  - Stabilì i primi protocolli di commercio con i Gondolieri, creando una relazione unica
  - Documentato contatto con un gruppo di Gondolieri Luminosi, suggerendo una connessione più profonda con le creature mutate

### Vittorio Visconti

- **Origine**: Vault 142 (Milano - Fortezza Futura)
- **Ruolo Pre-Guerra**: Chirurgo ortopedico con un interesse nella storia familiare
- **Emerso**: 2190
- **Contributo**: Fondatore della dinastia dei "Nuovi Visconti" e primo Duca di Milano post-apocalittico
- **Caratteristiche distintive**:
...
- **Contributo**: Fondatore dei protocolli militari della Fratellanza Alpina e primo "Guardiano dei Passi"
- **Caratteristiche distintive**:
...
- **Eredità**:
  - Sistema gerarchico militarizzato della Fratellanza Alpina
  - Codice d'onore ancora seguito dai membri della Fratellanza
...
- **Caratteristiche distintive**:
  - Completa immunità naturale agli effetti del MnemoPulse grazie a una rara condizione neurologica
  ...
  - Mantenimento di un diario dettagliato delle vere condizioni nel Vault 142
- **Eredità**:
  - Tecniche di "Guarigione dei Ricordi" ancora in uso dai Custodi del Tempo
  - Rete clandestina di "Guaritori della Memoria" attiva in tutto il wasteland
  - Sviluppo dei primi "Caschi Mnestici" per la deprogrammazione
  - La "Sindrome dell'Eco", inizialmente descritta nei suoi appunti, è ora riconosciuta come condizione medica

### Maestro Aurelio Fabbri

- **Origine**: Vault R-27 (Firenze - RIR)
...
- **Eredità**:
  - Fondatore della corrente artistica "Neo-Rinascimentale" che domina l'estetica delle Città-Stato
  - Le sue opere contengono informazioni storiche codificate ancora studiate dai Custodi del Tempo
...
- **Origine**: Vault 250 (Bologna - Fortezza Futura)
...
- **Contributo**: Mantenimento di un archivio segreto con dati sui veri esperimenti e sul Progetto "Ri-Genesis"
- **Caratteristiche distintive**:
  - Conoscenza diretta della struttura e del funzionamento della rete di vault
  - Accesso a documenti tecnici autentici sul sistema MnemoPulse
  - Comprensione dei codici e protocolli utilizzati da Fortezza Futura
  - Tecnica di memorizzazione collettiva per preservare informazioni critiche senza supporti fisici
- **Eredità**:
  - Fornito supporto tecnico cruciale ai Custodi del Tempo
  ...
  - Costantemente braccati dalle Ombre del Verbo, si spostano continuamente lasciando frammenti di informazione in "depositi" nascosti

### "La Nonna delle Acque" (Giorgina Zanon)

- **Origine**: Vault R-12 (Foggia - RIR)
...
- **Origine**: Vault V-01 (Città del Vaticano)
- **Ruolo Pre-Guerra**: Archivista vaticano con formazione in paleografia
- **Emerso**: Data sconosciuta, attivo dal 2200 circa
- **Contributo**: Primo leader delle Ombre del Verbo e architetto della revisione storica sistematica
- **Caratteristiche distintive**:
  - Piena consapevolezza della vera storia e del Progetto "Ri-Genesis"
...
- **Eredità**:
  - Struttura operativa delle Ombre del Verbo ancora in uso
...
- **Eredità**:
  ...
  - Fondazione della "Gilda dei Comunicatori" nella Repubblica di Venezia
...
- **Contributo**: Ex agente delle Ombre del Verbo pentito, fonte cruciale di informazioni sul Progetto "Ri-Genesis"
- **Caratteristiche distintive**:
  - Conoscenza diretta delle operazioni interne delle Ombre del Verbo
...
- **Eredità**:
  - Fondatore della rete di "informatori penitenti" all'interno dello Stato Pontificio
  - Creatore del sistema di codici utilizzato dai Custodi del Tempo
  - La sua testimonianza ha fornito la prima conferma documentata dell'esistenza delle Ombre del Verbo
...
- **Contributo**: Uno dei primi Gondolieri Luminosi e attuale Doge delle Maree
- **Caratteristiche distintive**:
  - Gondoliero Luminoso di circa 190 anni, potenzialmente uno dei sopravvissuti originali del Vault 186
...
- **Eredità**:
  - Creatore del "Concerto delle Acque", sistema di governo dei Gondolieri
  - Architetto dell'alleanza segreta tra Gondolieri e Repubblica di Venezia
...
- **Origine**: Vault R-33 (Siracusa - RIR)
- **Ruolo Pre-Guerra**: Psichiatra infantile specializzata in disturbi dell'identità
- **Emersa**: 2240
- **Contributo**: Pioniera nella comprensione e trattamento della "Psicosi da Duplicazione Mnestica"
- **Caratteristiche distintive**:
  ...
  - Comprensione profonda dei meccanismi del sistema MemorItalia e dei suoi effetti sulla percezione dell'identità
...
- **Eredità**:
  ...
  - Le sue tecniche terapeutiche sono alla base dei protocolli utilizzati dai Custodi del Tempo
  - I "Diari dell'Identità", la sua opera principale, sono un testo fondamentale per comprendere gli effetti del condizionamento
  - Ha formato la prima generazione di "Guaritori della Memoria" indipendenti
...
- **Origine**: Vault R-21 (Potenza - RIR)
- **Emersi**: Mai veramente emersi - mantengono una comunità isolata nel vault originale
- **Base attuale**: Vault R-21, con esploratori occasionali nel mondo esterno
- **Caratteristiche distintive**:
...
- **Base attuale**: Principalmente Repubblica di Venezia, dove le loro abilità sono particolarmente apprezzate
- **Caratteristiche distintive**:
...
- **Origine**: Vault 250 (Bologna - Fortezza Futura), livelli inferiori scoperti solo nel 2288
- **Ruolo Pre-Guerra**: Storico, specialista in storiografia e manipolazione narrativa
- **Emerso**: 2289
- **Contributo**: Fonte primaria di informazioni sul funzionamento interno del Progetto "Ri-Genesis"
- **Caratteristiche distintive**:
...
- **Impatto attuale**:
  - Consulente principale dei Custodi del Tempo per la decodifica di documenti del Comitato Congiunto
  ...
  - Attualmente (2293) sotto protezione nella Repubblica di Venezia, braccato dalle Ombre del Verbo

### Chiara "Profondità"

- **Origine**: Nata da sopravvissuti del Vault 186, seconda generazione di Gondolieri Luminosi
- **Nata**: Circa 2240 nelle acque della Laguna Veneta
- **Contributo**: Principale mediatrice tra comunità umane e Gondolieri, esperta recuperatrice
- **Caratteristiche distintive**:
  - Gondoliera Luminosa di mezza età con luminescenza blu-verde particolarmente intensa agli arti
  - Ex membro della Scuola di Santa Marina, ora guida indipendente
  - Capacità unica di navigare sia nel mondo dei Gondolieri che in quello umano
...
- **Attività attuale**:
  ...
  - Ricerca di un leggendario laboratorio sommerso della Fortezza Futura
  - Sviluppo di tecniche di comunicazione avanzate tra umani e Gondolieri

### Padre Tommaso Brancacci

- **Origine**: Nato nello Stato Pontificio Rinato da sopravvissuti del Vault 117, terza generazione
- **Nato**: 2260 a Parthenope Vaticana
- **Contributo**: Ex membro delle Ombre del Verbo passato segretamente ai Custodi del Tempo
- **Caratteristiche distintive**:
  - Formazione completa come agente delle Ombre del Verbo
...
- **Attività attuale**:
  - Fornisce informazioni sui movimenti delle Ombre del Verbo ai Custodi del Tempo
  - Aiuta segretamente individui con "Sindrome dell'Eco" a sfuggire alla "purificazione"
  - Documenta atrocità e abusi commessi in nome della "preservazione della verità"
  - Costruisce gradualmente una rete di resistenza all'interno dello Stato Pontificio

### La "Muta" (Ada Carnevale)

- **Origine**: Vault R-04 (Napoli - RIR), scoperta in una sezione sigillata nel 2281
- **Emersa**: 2282
...
- **Caratteristiche distintive**:
  ...
  - Memoria eccezionale per suoni e pattern, utilizzata per identificare frequenze MemorItalia
...
- **Attività attuale**:
  ...
  - Collabora con i Custodi del Tempo per preservare comunicazioni sicure
...
- I meccanismi di controllo sociale dello Stato Pontificio sono versioni scalate dei sistemi sperimentati nel Vault 117
- I movimenti di resistenza come i Custodi del Tempo sono nati dalla collaborazione di individui resistenti al condizionamento
...
- Scontri frequenti tra Custodi del Tempo e Ombre del Verbo per il controllo di strutture appena localizzate
