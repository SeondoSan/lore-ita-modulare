...
- **Esempi notevoli**:
  - **Vault 117 (Roma)**: Simulazione di Stato Pontificio medievale
  - **Vault 142 (Milano)**: Replicazione delle condizioni della Peste Nera
  - **Vault 186 (Chioggia)**: Adattamento umano alla vita acquatica (origine dei Gondolieri)
