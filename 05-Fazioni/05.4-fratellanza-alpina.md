...
- **Contesto**: Risposta all'espansione dello [Stato Pontificio](05.1-stato-pontificio.md) in aree montane del Centro Italia
- **Operazioni principali**:
  - "Operazione Aquila" (2291): Occupazione di valichi strategici sull'Appennino centrale
  - "Difesa del Terminillo" (2292): Resistenza contro un tentativo di controffensiva delle [Guardie Vaticane](05.1-stato-pontificio.md#guardie-vaticane)
...
[← Torna all'indice principale](../../01-Indice/01.0-indice-principale.md) | [← Lega dei Navigli](05.3-lega-navigli.md) | [Le Famiglie →](05.5-famiglie.md)