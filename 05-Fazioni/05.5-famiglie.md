...
- **Territorio**: Nessun controllo territoriale ufficiale, ma forte influenza in tutto il Sud Italia e infiltrazioni significative nelle [Città-Stato del Nord](05.2-citta-stato-nord.md)
...
#### Casata Esposito
- **Territorio di influenza**: Napoli e Campania, con forti connessioni nello [Stato Pontificio](05.1-stato-pontificio.md)
...
- **Caratteristiche distintive**: 
  ...
  - Alleanza strategica con elementi corrotti delle [Guardie Vaticane](05.1-stato-pontificio.md#guardie-vaticane)
...
- **"Via Appia Occulta"**:
  ...
  - Controllata congiuntamente dalle Famiglie e dalle [Ombre del Verbo](05.1-stato-pontificio.md#le-ombre-del-verbo) ([Stato Pontificio](05.1-stato-pontificio.md))
...
- **Controllo delle rotte commerciali**:
  ...
  - Collaborazione con la [Lega dei Navigli](05.3-lega-navigli.md) per il transito di merci lungo vie acquatiche
...
- **Commercio specializzato**:
  ...
  - Sistema di appalti nelle [Città-Stato del Nord](05.2-citta-stato-nord.md) controllati attraverso intermediari
...
Una delle relazioni più strategiche mantenute dalle Famiglie è l'accordo tacito con la [Fratellanza Alpina](05.4-fratellanza-alpina.md):
...
- **Origine storica**:
  ...
  - Negoziazione guidata da "mediatori neutri" della [Lega dei Navigli](05.3-lega-navigli.md)
...
I rapporti con lo [Stato Pontificio](05.1-stato-pontificio.md) sono complessi e sfaccettati:
...
- **Realtà operativa**:
  ...
  - Controllo congiunto della "[Via Appia Occulta](#via-appia-occulta)" con le [Ombre del Verbo](05.1-stato-pontificio.md#le-ombre-del-verbo)
...
- **Economia interconnessa**:
  ...
  - Corruzione diffusa tra le [Guardie Vaticane](05.1-stato-pontificio.md#guardie-vaticane), specialmente in aree di confine
...
La penetrazione nelle [Città-Stato del Nord](05.2-citta-stato-nord.md) segue un approccio più sottile:
...
- **Risoluzione**:
  - "Concordato del Sud" - trattato di pace negoziato sotto minaccia di intervento dello [Stato Pontificio](05.1-stato-pontificio.md)
...
- **Esecuzione**:
  - Corruzione sistematica di ufficiali di dogana e [Guardie Vaticane](05.1-stato-pontificio.md#guardie-vaticane)
...
- **Strategia**: Infiltrazione sistematica nelle strutture economiche delle [Città-Stato del Nord](05.2-citta-stato-nord.md)
- **Tattiche principali**:
...
- **Stato attuale**:
  ...
  - Conflitto di interessi con la [Lega dei Navigli](05.3-lega-navigli.md) per il controllo delle rotte commerciali
...
[← Torna all'indice principale](../../01-Indice/01.0-indice-principale.md) | [← Fratellanza Alpina](05.4-fratellanza-alpina.md) | [Custodi del Tempo →](05.6-custodi-tempo.md)