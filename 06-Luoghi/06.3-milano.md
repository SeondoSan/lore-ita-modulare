...
Il Ducato controlla un'area che si estende per circa 30 chilometri in ogni direzione dal centro di Milano, comprendendo diversi insediamenti satellite e zone agricole. Il territorio è delimitato da una serie di avamposti fortificati e pattugliato regolarmente dalla Guardia Ducale.
...
- **Palazzo Ducale**: Costruito sulle fondamenta del Castello Sforzesco, è la sede del governo e residenza del Duca.
...
- **Campi di Addestramento**: Aree dedicate alla formazione della Guardia Ducale.
...
- **Presidi Militari**: Basi della Guardia Ducale che proteggono i confini.
...
- **Il Duca**: Capo dello stato e comandante supremo delle forze armate. Attuale Duca: Ludovico Visconti (in carica dal 2283).
- **Consiglio Tecnocratico**: Composto da 12 esperti settoriali che supervisionano i diversi aspetti dell'amministrazione.
...
3. **Guardia Ducale**: Forze militari e di sicurezza, godono di status privilegiato.
...
### Sistema monetario
Il Ducato emette la "Lira Tecnica", moneta in lega metallica con incorporati piccoli elementi tecnologici che ne rendono difficile la contraffazione. È considerata la valuta più stabile del nord Italia.
...
Nei sotterranei del Palazzo Ducale si trova l'Archivio Tecnologico, una vasta collezione di progetti, schemi e prototipi recuperati dalle rovine. L'accesso è rigorosamente controllato e limitato agli specialisti autorizzati dal Consiglio Tecnocratico.
...
### Alleanze
- **Lega dei Navigli**: Stretta alleanza economica e difensiva con gli insediamenti collegati dai canali della pianura padana.
- **Fratellanza Alpina**: Collaborazione per lo sfruttamento delle risorse montane e la sicurezza dei passi alpini.
- **Torino Tecnologica**: Accordo di scambio tecnologico con l'altro grande centro industriale del nord.

### Rivalità
- **Repubblica Serenissima di Venezia**: Competizione commerciale e occasionali dispute territoriali nella pianura orientale.
...
- **Stato Pontificio**: Differenze ideologiche fondamentali, soprattutto riguardo all'approccio alla tecnologia.
...
Un programma segreto di ricerca sui miglioramenti biotecnologici umani, condotto in laboratori sotterranei sotto il controllo diretto del Duca.
...
- **2283**: Morte del Duca Alessandro e ascesa al potere di suo figlio Ludovico, noto per la sua visione espansionistica.
...
- **2287**: Breve conflitto con Venezia per il controllo delle vie commerciali orientali, concluso con un trattato di compromesso.
...
- **2291**: Inizio della costruzione della "Via del Progresso", una strada fortificata che collegherà Milano a Torino.
- **2293**: Completamento della prima linea del sistema di tram a vapore che collega tutti i quartieri della città.

---

[← Torna all'indice principale](../01.0-indice-principale.md) | [← Repubblica Serenissima di Venezia](06.2-venezia.md) | [Altri Centri Urbani →](06.4-altri-centri.md)
